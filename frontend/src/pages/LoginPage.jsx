...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-nods-bg p-5">
            <motion.div
                initial={{ opacity: 0, y: 30, scale: 0.95 }}
                animate={{ opacity: 1, y: 0, scale: 1 }}
                transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
                className="w-full max-w-md bg-nods-card rounded-3xl shadow-xl border border-nods-border p-12 text-center relative overflow-hidden"
            >
                {/* Top accent line */}
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-nods-accent via-indigo-500 to-purple-500" />
                ...
                <form onSubmit={handleLogin} className="mt-8 text-left space-y-5">
                    ...
                    <div>
                        <label className="flex items-center gap-1.5 text-xs font-semibold text-nods-text-muted mb-2 uppercase tracking-wider">
